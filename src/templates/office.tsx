...
export const config: TemplateConfig = {
  stream: {
    ...
    fields: ["id", "name", "slug", "c_authAllowedEmails", "c_secureRTF", "address"],
...
export const getAuthScope: GetAuthScope<TemplateProps> = ({document}) => {
  return `(claims.email in [${(document.c_authAllowedEmails ?? []).join(",")}]) && claims.email.endsWith("@yext.com")`;
}
...
const EntityPage: Template<TemplateRenderProps> = ({
  ...
  const { name, address, c_secureRTF } = document;
